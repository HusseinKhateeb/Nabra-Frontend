...
class _InstructionsPageState extends State<InstructionsPage> {
  ...
  final List<InstructionStep> steps = [
    InstructionStep(
      title: 'تحدث بلغة الشفاه',
      description: 'تحدث ببطء ووضوح امام الكاميرا باستخدام حركات شفاهك فقط',
      step: 1,
    ),
    InstructionStep(
      title: 'التقط وجهك بالكاميرا',
      description: 'تأكد من ان وجهك مضاء جيداً وأن الكاميرا تلتقط شفتيك بوضوح',
      step: 2,
    ),
    InstructionStep(
      title: 'احصل على النتيجة',
      description: 'سيظهر النص المحول على الشاشة ويمكنك تحويله الى صوت',
      step: 3,
    ),
  ];
